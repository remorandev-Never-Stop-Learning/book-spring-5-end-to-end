...
import es.spring5.remoran.cms.domain.model.Review;
import es.spring5.remoran.cms.domain.vo.NewsRequest;
...
public class NewsResource {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<News> updateNews(@PathVariable("id") String id, NewsRequest newsRequest){
        return new ResponseEntity<>(new News(), HttpStatus.OK);
    }

    @GetMapping(value =  "/{id}/news/{userId}")
