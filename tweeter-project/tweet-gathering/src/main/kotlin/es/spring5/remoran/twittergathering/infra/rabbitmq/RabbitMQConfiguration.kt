package es.spring5.remoran.twittergathering.infra.rabbitmq
...
@Configuration
class RabbitMQConfiguration(@Value("\${queue.twitter}") private val queue: String,
                            @Value("\${exchange.twitter}") private val exchange: String,
                            @Value("\${routing-key.track}") private val routingKey: String) {
